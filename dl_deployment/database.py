...
def get_deployment_config():
    '''
    This function will retrieve the deployement config file stored in the Azure blob container
    Parameters:
        Input:
            None : Take no input arguments
        Output:
            config : Deployment config in JSON format.
    '''
    # Initializing config
    config = None
    ...
    # Holder of the config file
    blob_client = blob_service_client.get_blob_client(container=container_name, blob='Configs/DeployConfig.json')
